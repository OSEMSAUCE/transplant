...
<div class="header-container">
	...
	<AccountMenu />
	<a href="https://github.com/OSEMSAUCE/OSEM" target="_blank" rel="noopener noreferrer" aria-label="Visit OSEMSAUCE on GitHub" style="display: flex; align-items: center; gap: 6px; padding: 0 8px;">
